...
class TopicTestResultPage extends ConsumerWidget {
  const TopicTestResultPage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Butonlar
            AppButton(
              text: 'Kazanım Analizine Git',
              icon: Icons.analytics_outlined,
              onPressed: () {
                context.pushReplacement(
                  '/student/konu-kitaplari/topic-analysis',
                  extra: result.topicId,
                );
              },
